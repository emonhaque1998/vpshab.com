<x-home-layout>
  ...
  <div class="top-header overlay">
    <div class="lazyload">
      <img src="./assets/img/topbanner08.jpg" class="img-defaultbanner" alt="About us">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-12 mb-5">
          <div class="wrapper">
            ...
            <div class="included">
              <div class="mb-3 h4">Why Choose Antler?</div>
              <ul>
  ...
  <!-- ***** TEAM ***** -->
  <section class="sec-normal sec-bg2 bg-colorstyle tophalfpadding nobottompadding">
    <div class="team">
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 text-center">
            <h2 class="section-heading mergecolor">Meet Our Management Team</h2>
          ...
          <div class="col-sm-12 col-md-4">
            <div class="wrapper">
              ...
              <div class="team-info bg-seccolorstyle noshadow">
                ...
                <div class="subheading seccolor">Commercial Department</div>
                <div class="desc seccolor">Lorem ipsum dolor sit amet, consectetur adipiscing elit</div>
                <a href="#" class="btn btn-default-yellow-fill mt-4">Contact</a>
              </div>
            </div>
  ...
  <x-map/>
  <!-- ***** CASE STUDY ***** -->
  <section class="casestudy sec-bg2 bg-colorstyle pt-100 pb-5">
    <div class="container">
                  ...
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      ...
                      <div class="content-info text-muted">
                        <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totamer rem aperiam, eaque ipsa quae ab illo.</p>
                        <div class="mb-3"> Michael Jones - Executive Director</div>
                        <a href="./assets/casestudy/casestudy-everthgroup.pdf" class="btn btn-default-yellow-fill mb-2" title="Case Study">Case Study Download</a>
                      </div>
                    </div>
                    <div class="swiper-slide">
                      ...
                      <div class="content-info text-muted">
                        ...
                        <a href="./assets/casestudy/casestudy-growtop.pdf" class="btn btn-default-yellow-fill mb-2" title="Case Study">Case Study Download</a>
                      </div>
                    </div>
                  </div>
  ...
  <!-- ***** VISIT ***** -->
  <section class="getready sec-bg2 bg-colorstyle">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-8">
          <div class="column-support-txt">
            <h2 class="section-heading mergecolor">Visit our facilities!</h2>
            <p class="section-subheading mergecolor">Please schedule an date with our sales manager if you're interested in visit us.</p>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="btn-floats">
            <a href="contact.html" class="btn btn-default-purple-fill">Contact Sales Manager</a>
          </div>
        </div>
      </div>
    </div>
