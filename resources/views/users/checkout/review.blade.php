            ...
            <div class="row">
                                            ...
                                            <div class="table-responsive-lg">
                                                <table class="table compare">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="seccolor">
                                                            <td>{{ $product->title ?? '' }}</td>
                                                            <td><input id="quantityNumber" type="number" value="1"
                                                                    aria-label="Number" class="form-control"></td>
                                                            <td>{{ $product->currency ?? '' }}
                                                                <span class=""
                ...
                <div class="col-md-12 col-lg-4">
                    <aside id="sidebar" class="mt-80 sidebar sec-bg1 bg-colorstyle noshadow">
                        ...
                        <a id="checkoutRequest" href="{{ url("/checkout/$product->monthly_price/$product->slug") }}"
