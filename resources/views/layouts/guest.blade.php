...
<head>
    ...
    <!-- RTL Style -->
    <link type="text/css" href="{{ asset('assets/css/rtl/bootstrap-rtl.min.css') }}" rel='stylesheet' class="rtl"
        disabled>
    <link type="text/css" href="{{ asset('assets/css/rtl/theme-rtl.min.css') }}" rel='stylesheet' class="rtl"
        disabled>
    <!-- CSS Style -->
