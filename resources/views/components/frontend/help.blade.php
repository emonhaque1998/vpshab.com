            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="help-container bg-seccolorstyle">
                        <a href="#" id="liveChat" class="help-item" title="Live Chat">
                            <div class="img">
                                <div class="lazyload">
                                    <svg class="svg ico" viewBox="0 0 32 32" width="60" height="60">
                                        <path fill="#5e686c"
                            ...
                            <div class="inform">
                                ...
                                <div class="description seccolor">At vero eos et accusamus et iusto odio
                                    dignissimos.</div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="help-container bg-seccolorstyle">
                        <a href="knowledgebase-list" class="help-item" title="Knowledge List">
                            ...
                            <div class="inform">
                                ...
                                <div class="description seccolor">On the other hand, we denounce with righteous.
                                </div>
                            </div>
                        </a>
                    </div>
