        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-4">
            <div class="service-section bg-colorstyle noshadow">
              ...
              <div class="title mergecolor">Lisbon</div>
              <div class="subtitle seccolor">Call us: + (123) 1300-656-1046 <br>Office - No.01 - 399-0 Lorem Street City Portugal</div>
              <a class="btn btn-default-yellow-fill popup-gmaps"
              href="https://maps.google.com/maps?q=221B+Baker+Street,+London,+United+Kingdom&amp;hl=en&amp;t=v&amp;hnear=221B+Baker+St,+London+NW1+6XE,+United+Kingdom">Google Maps</a>
            </div>
          </div>
          <div class="col-sm-12 col-md-4">
            <div class="service-section bg-colorstyle noshadow">
              ...
              <div class="title mergecolor">Melbourne</div>
              <div class="subtitle seccolor">Call us: + (123) 1300-656-1046 <br>Office - No.02 - 399-0 Lorem Street City London</div>
              <a class="btn btn-default-yellow-fill popup-gmaps"
              href="https://maps.google.com/maps?q=221B+Baker+Street,+London,+United+Kingdom&amp;hl=en&amp;t=v&amp;hnear=221B+Baker+St,+London+NW1+6XE,+United+Kingdom">Google Maps</a>
            </div>
          </div>
            ...
            <div class="help-container bg-colorstyle">
              <a href="#" class="help-item">
                ...
                <div class="inform">
                  ...
                  <div class="description seccolor">At vero eos et accusamus iusto odio dignissimos.</div>
                </div>
              </a>
            </div>
          </div>
            ...
            <div class="help-container bg-colorstyle">
              <a href="#" class="help-item">
                ...
                <div class="inform">
                  ...
                  <div class="description seccolor">Contrary to popular belief, Lorem Ipsum is not simply.</div>
                </div>
              </a>
            </div>
          </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 position-relative">
                    <div class="cd-select mt-4">
                      ...
                      <select aria-label="Choose Department" id="department" name="department" class="select-filter">
                  ...
                  <div class="col-md-6 position-relative mt-5">
                    ...
                    <label for="checkbox" class="checkbox-label c-grey mb-4 seccolor"><span>I have read and accept the terms of the privacy policy - <a href="legal" class="golink-dark">RGPD</a></span></label>
